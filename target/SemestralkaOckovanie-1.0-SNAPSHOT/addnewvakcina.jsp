...
<div class="container" align="center"><h1>Registrácia novej vakcíny</h1></div>
...
<%--<div class="container">--%>
<%--    <h2 style="color: red"> Číslo záznamu: <%out.println(id);%> </h2>--%>
<%--</div>--%>
                ...
                <div class="card-body">
                    ...
                    <form action="AddDodavateliaServlet"  id="form" method="Post">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="col-md-4">
                                     <div class="form-group">
                                         ...
                                         <input type="text" name="vakcina" id="vakcina" class="form-control" placeholder="Zadajte vakcínu">
                                     </div>
                                 </div>
                         ...
                         <div class="form-row">
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="faktura" id="faktura" class="form-control" placeholder="Zadajte číslo faktúry">
                                </div>
                             </div>
                             ...
                             <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="mnozstvo" id="mnozstvo" class="form-control" placeholder="Zadajte množstvo">
                                </div>
                             </div>
                         </div>
                         ...
                         <div class="form-group mt-4 mb-0">
                             <button type="submit" class="btn btn-warning btn-block">Pridať vakcínu do databázy</button>
                        <br>
                             ...
                             <%
                                 ...
                                 {
                             %>
                             <h2>Vakcína bola pridaná do databázy.</h2>

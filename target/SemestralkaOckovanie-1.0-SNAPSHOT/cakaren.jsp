...
<html>
<head>
    <title>Cakaren na ockovanie</title>
...
<div class="container" align="center"><h1>Prehľad čakajúcich na zaočkovanie</h1></div>
                        ...
                        <table  id="cakaren" class="table table-striped table-active">
                            <thead>
                                ...
                                <%
                                    ...
                                    List<Prihlaseny> prihlasenyList = prihlasenyController.getAllNezaockovany();
                            ...
                            <tr>
                                ...
                                <td><%=p.getTelcislo()%></td>
                                <td><%=p.getEmail()%></td>
                                <td class="bg-warning"><%=p.getStatus()%></td>
                                <td><a href="potvrdzaockovanie?id=<%=p.getId()%>"><i class="fas fa-syringe"> Zaočkovať <i class="fas fa-syringe"></i></i></a></td>
                                <td><a href="odstranzaockovanie?id=<%=p.getId()%>">Zmazať <i class="fas fa-trash"></i></a></td>
                            </tr>
